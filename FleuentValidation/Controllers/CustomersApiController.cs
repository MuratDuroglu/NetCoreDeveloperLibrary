...
namespace FleuentValidation.Controllers
{
    ...
    public class CustomersApiController : ControllerBase
    {
        ...
        public CustomersApiController(AppDbContext context, IValidator<Customer> _customerValidatorr)
        {
            _context = context;
            _customerValidator = _customerValidatorr;
    }
